...
export default function FooterSection({ id }: { id?: string }) {
    return (
        <footer id={id} className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Amauta Asesores, All rights reserved</span>
            </div>
        </footer>
    )
}
