...
export const Logo = ({ className }: { className?: string; uniColor?: boolean }) => {
    return (
        <svg
            ...
            className={cn(
                "h-13 w-auto transition-colors duration-300",
                className
            )}
        >
            <defs>
                {/* Degradado modo claro: azul -> dorado */}
                <linearGradient id="logo-gradient-light" x1="0" y1="0" x2="200" y2="0">
                    <stop stopColor="#192537" />
                    <stop offset="1" stopColor="#b09e80" />
                </linearGradient>

                {/* Degradado modo oscuro: blanco -> dorado */}
                <linearGradient id="logo-gradient-dark" x1="0" y1="0" x2="200" y2="0">
